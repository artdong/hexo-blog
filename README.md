...
:smiley: 欢迎访问我的博客  在线演示地址https://artdong.github.io/blog

## 先看看效果

![ionic3-awesome.gif](https://upload-images.jianshu.io/upload_images/3100736-e6a38601c11a2df7.gif?imageMogr2/auto-orient/strip)

### 在线预览

[点我点我](https://artdong.github.io/blog/)

### 源码地址

[https://github.com/artdong/hexo-blog](https://github.com/artdong/hexo-blog)
...
* 第一步，安装hexo环境
* 第二步，安装下载 [Hexo 模版](https://hexo.io)，即初始化[Hexo 模版](https://hexo.io)
...
修改`Home`为`主菜单`，修改`Archives`为 `文章`，刷新浏览器http://localhost:4000 即可看到效果
...
在github上下载[NexT主题源码]( https://github.com/xulayen/hexo-theme-next)
...
祝，早新手早日玩转hexo博客，这是 博主 https://artdong.github.io/blog  的博客，文章不定期更新。

hexo官网地址 http://theme-next.iissnan.com/getting-started.html

---

[经典前端面试题](https://github.com/daily-interview/fe-interview)每日更新，欢迎参与讨论，地址：[https://github.com/daily-interview/fe-interview](https://github.com/daily-interview/fe-interview)。
